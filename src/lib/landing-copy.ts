...
// Çeviriler LLM yazımı + çok-ajanlı ana-dil-düzeyi editör denetiminden geçti (2026-07-04: dil başına
// bağımsız inceleme + çürütmeli hakem turu; 8 dilde ~57 düzeltme uygulandı, 4 öneri hakemce reddedildi).
// Büyük pazarlama lansmanı öncesi insan ana-dil okuması yine de önerilir.
...
export const LANDING_COPY: Record<LandingLocale, LandingCopy> = {
  tr: {
    ...
    hero: {
      ...
      p: "AI ile triyajdan geçin, 70 dilde simültane tercüme hizmetiyle akredite uzmanlarla görüntülü görüşün ve her şey dahil tedavi planıyla seyahat edin — uçuş, otel ve iyileşme takibi bizden.",
      stats: [
    ...
    how: {
      ...
      steps: [
        { t: "Ücretsiz değerlendirme", d: "Şikayetinizi ve belgelerinizi paylaşın; AI triyajımız sizi doğru branşa yönlendirsin." },
        { t: "Kişiye özel plan", d: "Uzmanla video görüşme, ardından her şey dahil şeffaf bir paket." },
        { t: "Gelin & iyileşin", d: "Uçuş, otel, transfer ve tıbbi tercüman — hepsi ayarlanır." },
        { t: "Evde takip", d: "Günlük iyileşme kontrolleri ve kritik durum uyarıları, nerede olursanız olun." },
      ],
    },
    doctors: { h: "Uzmanlarla tanışın" },
    testimonial: {
      quote: "“İlk video görüşmeden eve döndükten sonraki kontrollere kadar her şey organize edilmişti. Yabancı bir ülkede bir an bile kendimi yalnız hissetmedim.”",
      name: "James W. · Birleşik Krallık", meta: "Saç ekimi · İstanbul'da 2 gece",
    },
    cta: { h: "Tedavinize açılan kapıyı aralamaya hazır mısınız?", p: "Ücretsiz değerlendirmeyle başlayın — dakikalar içinde branş yönlendirmesi, aciliyet skoru ve tedavi planı alın.", b: "Doktorla Görüş" },
    ...
    showcase: {
      slides: [
        { tag: "Doktorla Görüş", title: "AURA'yı açın — video görüşmeniz başlasın.", sub: "Görüşme doğrudan ana sayfamızdan başlar, her cihazdan. Siz konuşurken tıbbi terimler 70 dilde anında çevrilir.", cta: "Hemen başla" },
        { tag: "İkinci Görüş", title: "Teşhisinize uzman gözüyle ikinci bir bakış.", sub: "Elinizde bir teşhis mi var? Raporlarınızı paylaşın; bağımsız, akredite bir uzman bunları yeniden değerlendirsin — büyük karar öncesi netlik ve huzur.", cta: "İkinci görüş al" },
        { tag: "Ücretsiz Sağlık Hizmeti", title: "Sağlık bir insan hakkı — ayrıcalık değil.", sub: "Sağlık hizmetine ulaşamayanların yanında gönüllü doktorlarımız var. Birbirimize sahip çıkmak hepimizin sorumluluğudur.", cta: "Başvur" },
      ],
  ...
  en: {
    ...
    hero: {
      ...
      p: "Start with AI triage, meet accredited specialists over video with live interpreting in 70 languages, and travel with an all-inclusive treatment plan — flights, hotel and aftercare handled.",
      stats: [
    ...
    how: {
      eyebrow: "How it works", h: "Four steps — everything taken care of.",
      steps: [
        ...
        { t: "Arrive & heal", d: "Flights, hotel, transfers and a medical interpreter — all arranged." },
    ...
    cta: { h: "Ready to open the door to your care?", p: "Start with a free assessment — get a specialty recommendation, an urgency score and a treatment plan in minutes.", b: "Talk to a Doctor" },
    ...
    showcase: {
      ...
      live: "LIVE",
      s2: { doc: "Diagnostic report", reviewing: "Reviewing…", verified: "Second opinion", note: "Independent review" },
    },
  },
  ...
  de: {
    ...
    how: {
      ...
      steps: [
        { t: "Kostenlose Ersteinschätzung", d: "Teilen Sie Ihre Beschwerden und Unterlagen; unsere KI-Triage leitet Sie an die richtige Fachrichtung weiter." },
        { t: "Individueller Plan", d: "Videosprechstunde mit dem Facharzt, danach ein transparentes Rundum-Paket." },
        { t: "Anreisen & genesen", d: "Flüge, Hotel, Transfers und ein medizinischer Dolmetscher — alles organisiert." },
        { t: "Nachsorge zu Hause", d: "Tägliche Genesungs-Check-ins und Warnmeldungen bei kritischen Anzeichen — wo immer Sie sind." },
      ],
    },
    ...
    cta: { h: "Bereit für den ersten Schritt zu Ihrer Behandlung?", p: "Starten Sie mit einer kostenlosen Ersteinschätzung — Fachrichtung, Dringlichkeitseinstufung und Behandlungsplan in wenigen Minuten.", b: "Arzt sprechen" },
    footer: { desc: "Telemedizin & Gesundheitstourismus, aus einer Hand.", how: "So funktioniert's", patientLogin: "Patienten-Login", patientSignup: "Patienten-Registrierung", corporate: "Login für Fachpersonal", doctorSignup: "Arzt-Registrierung" },
    showcase: {
      slides: [
        ...
        { tag: "Zweitmeinung", title: "Ein zweiter Expertenblick auf Ihre Diagnose.", sub: "Sie haben bereits eine Diagnose? Teilen Sie Ihre Befunde — ein unabhängiger, akkreditierter Facharzt prüft sie. Klarheit und Sicherheit vor jeder großen Entscheidung.", cta: "Zweitmeinung einholen" },
      ...
      live: "LIVE",
      s2: { doc: "Befundbericht", reviewing: "Wird geprüft…", verified: "Zweitmeinung", note: "Unabhängige Beurteilung" },
    },
  },
  ...
  fr: {
    ...
    hero: {
      ...
      p: "Évaluation par IA, consultations vidéo avec des spécialistes accrédités et interprétation simultanée dans 70 langues — puis voyagez avec un plan de traitement tout compris : vols, hôtel et suivi assurés.",
      stats: [
    ...
    how: {
      ...
      steps: [
        { t: "Évaluation gratuite", d: "Partagez vos symptômes et vos documents médicaux ; notre triage par IA vous oriente vers la bonne spécialité." },
        { t: "Plan sur mesure", d: "Consultation vidéo avec un spécialiste, puis un forfait transparent, tout compris." },
        { t: "Venez & rétablissez-vous", d: "Vols, hôtel, transferts et interprète médical — tout est organisé." },
        { t: "Suivi à domicile", d: "Contrôles quotidiens de récupération et alertes en cas de signes préoccupants, où que vous soyez." },
      ],
    },
    ...
    cta: { h: "Prêt à ouvrir la porte à vos soins ?", p: "Commencez par une évaluation gratuite — spécialité, score d'urgence et plan de traitement en quelques minutes.", b: "Parler à un médecin" },
    ...
    showcase: {
      slides: [
        { tag: "Parler à un médecin", title: "Ouvrez AURA — votre consultation vidéo commence.", sub: "Démarrez depuis notre page d'accueil, sur n'importe quel appareil. Pendant que vous parlez, les termes médicaux sont traduits instantanément dans 70 langues.", cta: "Commencer" },
        { tag: "Second avis", title: "Un second regard d'expert sur votre diagnostic.", sub: "Vous avez déjà un diagnostic ? Partagez vos comptes rendus : un spécialiste indépendant et accrédité les réévalue — clarté et sérénité avant toute grande décision.", cta: "Obtenir un second avis" },
        { tag: "Soins gratuits", title: "La santé est un droit fondamental — pas un privilège.", sub: "Quand les soins sont hors de portée, nos médecins bénévoles interviennent. Prendre soin les uns des autres est notre responsabilité à tous.", cta: "Faire une demande" },
      ],
      hp: { eyebrow: "Tourisme médical & télésanté", t1: "Des soins d'excellence", t2: "en Turquie.", btn: "Parler à un médecin" },
      live: "DIRECT",
      s2: { doc: "Compte rendu médical", reviewing: "Analyse en cours…", verified: "Second avis", note: "Évaluation indépendante" },
    },
  },
  ...
  ru: {
    ...
    how: {
      ...
      steps: [
        { t: "Бесплатная оценка", d: "Опишите жалобы и загрузите документы — ИИ-триаж направит вас к врачу нужного профиля." },
        ...
        { t: "Наблюдение дома", d: "Ежедневный контроль восстановления и уведомления о тревожных симптомах — где бы вы ни были." },
      ],
    },
    ...
    cta: { h: "Готовы сделать первый шаг к лечению?", p: "Начните с бесплатной оценки — нужный профиль врача, степень срочности и план лечения за считанные минуты.", b: "Поговорить с врачом" },
    ...
    showcase: {
      slides: [
        ...
        { tag: "Второе мнение", title: "Второй взгляд эксперта на ваш диагноз.", sub: "Уже есть диагноз? Поделитесь заключениями — независимый аккредитованный специалист изучит их заново. Ясность и спокойствие перед важным решением.", cta: "Получить второе мнение" },
        { tag: "Бесплатная медицинская помощь", title: "Здоровье — право человека, а не привилегия.", sub: "Когда помощь недоступна, на связь выходят наши врачи-волонтёры. Заботиться друг о друге — общая ответственность.", cta: "Подать заявку" },
      ],
  ...
  ar: {
    ...
    hero: {
      eyebrow: "السياحة العلاجية والرعاية الصحية عن بُعد",
      h: "بوابتك إلى رعاية صحية عالمية المستوى في تركيا.",
      p: "فرز أولي بالذكاء الاصطناعي، واستشارات فيديو مع أخصائيين معتمدين وترجمة فورية إلى 70 لغة، وخطة علاج شاملة لرحلتك — الطيران والفندق والمتابعة علينا.",
      stats: [
        { n: "+20k", l: "مريض دولي" },
        { n: "+40", l: "عيادة معتمدة" },
    ...
    how: {
      ...
      steps: [
        ...
        { t: "متابعة في المنزل", d: "متابعة يومية للتعافي وتنبيهات فورية عند ظهور علامات الخطر، أينما كنت." },
      ],
    },
    ...
    testimonial: {
      ...
      name: "جيمس دبليو · المملكة المتحدة", meta: "زراعة الشعر · ليلتان في إسطنبول",
    },
    cta: { h: "هل أنت مستعد لفتح باب رعايتك الصحية؟", p: "ابدأ بتقييم مجاني — احصل على التخصص ودرجة الاستعجال وخطة العلاج في دقائق.", b: "تحدث مع طبيب" },
    footer: { desc: "الرعاية الصحية عن بُعد والسياحة العلاجية، من البداية إلى النهاية.", how: "كيف نعمل", patientLogin: "دخول المرضى", patientSignup: "تسجيل المرضى", corporate: "دخول المختصين", doctorSignup: "تسجيل الأطباء" },
    showcase: {
      slides: [
        { tag: "تحدث مع طبيب", title: "افتح AURA — لتبدأ استشارتك بالفيديو.", sub: "ابدأ مباشرة من صفحتنا الرئيسية وعلى أي جهاز. وأثناء حديثك، تُترجم المصطلحات الطبية فوريًا إلى 70 لغة.", cta: "ابدأ الآن" },
        { tag: "رأي طبي ثانٍ", title: "نظرة ثانية من خبير على تشخيصك.", sub: "لديك تشخيص بالفعل؟ شارك تقاريرك ليراجعها أخصائي مستقل معتمد — وضوح وطمأنينة قبل أي قرار كبير.", cta: "احصل على رأي ثانٍ" },
        { tag: "رعاية مجانية", title: "الصحة حق إنساني — لا امتياز.", sub: "حين يتعذر الوصول إلى الرعاية، يتدخل أطباؤنا المتطوعون. رعاية بعضنا بعضًا مسؤوليتنا جميعًا.", cta: "قدّم طلبًا" },
      ],
      hp: { eyebrow: "السياحة العلاجية والرعاية الصحية عن بُعد", t1: "رعاية عالمية المستوى", t2: "في تركيا.", btn: "تحدث مع طبيب" },
      live: "مباشر",
  ...
  fa: {
    ...
    hero: {
      ...
      h: "دروازهٔ شما به مراقبت‌های درمانی سطح جهانی در ترکیه.",
      p: "تریاژ با هوش مصنوعی، ویزیت ویدیویی با متخصصان معتبر همراه با ترجمهٔ هم‌زمان به ۷۰ زبان و سفر با برنامهٔ درمانی همه‌چیز شامل — پرواز، هتل و پیگیری بهبودی با ما.",
      stats: [
    ...
    footer: { desc: "سلامت از راه دور و گردشگری درمانی، از آغاز تا پایان.", how: "چطور کار می‌کند", patientLogin: "ورود بیماران", patientSignup: "ثبت‌نام بیماران", corporate: "ورود متخصصان", doctorSignup: "ثبت‌نام پزشکان" },
    showcase: {
      slides: [
        ...
        { tag: "نظر دوم", title: "نگاه دوم یک متخصص به تشخیص شما.", sub: "تشخیصی دارید؟ گزارش‌های خود را به اشتراک بگذارید تا متخصصی مستقل و معتبر آن‌ها را بازبینی کند — وضوح و آرامش خاطر پیش از هر تصمیم بزرگ.", cta: "دریافت نظر دوم" },
        { tag: "خدمات درمانی رایگان", title: "سلامت یک حق انسانی است — نه یک امتیاز.", sub: "وقتی درمان در دسترس نیست، پزشکان داوطلب ما کنار شما هستند. مراقبت از یکدیگر مسئولیت همهٔ ماست.", cta: "درخواست دهید" },
      ],
  ...
  az: {
    ...
    hero: {
      eyebrow: "Sağlamlıq turizmi & telemedisina",
      h: "Türkiyədə dünya səviyyəli tibbi xidmətə açılan qapınız.",
      p: "Süni intellektlə ilkin qiymətləndirmə, 70 dildə canlı tərcümə ilə akkreditə olunmuş mütəxəssislərlə video görüş və hər şey daxil müalicə planı ilə səyahət — uçuş, otel və sağalmanıza nəzarət bizdən.",
      stats: [
        { n: "20k+", l: "Beynəlxalq xəstə" },
        { n: "40+", l: "Akkreditə olunmuş klinika" },
        { n: "4.9★", l: "Xəstə reytinqi" },
      ],
    },
    trust: "Akkreditə olunmuş və etibarlı",
    how: {
      ...
      steps: [
        ...
        { t: "Evdə izləmə", d: "Gündəlik sağalma yoxlamaları və təhlükə xəbərdarlıqları — harada olursunuzsa olun." },
      ],
    },
    ...
    cta: { h: "Müalicənizə açılan qapını aralamağa hazırsınızmı?", p: "Pulsuz qiymətləndirmə ilə başlayın — dəqiqələr içində ixtisas, təcililik balı və müalicə planı alın.", b: "Həkimlə danış" },
    footer: { desc: "Telemedisina və sağlamlıq turizmi — əvvəldən sonadək.", how: "Necə işləyir", patientLogin: "Xəstə girişi", patientSignup: "Xəstə üzvlüyü", corporate: "Korporativ giriş", doctorSignup: "Həkim qeydiyyatı" },
    showcase: {
      slides: [
        ...
        { tag: "İkinci rəy", title: "Diaqnozunuza mütəxəssisdən ikinci baxış.", sub: "Artıq diaqnozunuz varmı? Müayinə nəticələrinizi paylaşın; müstəqil, akkreditə olunmuş mütəxəssis onları yenidən qiymətləndirsin — böyük qərardan öncə aydınlıq və ürək rahatlığı.", cta: "İkinci rəy al" },
        { tag: "Pulsuz Sağlamlıq Xidməti", title: "Sağlamlıq insan hüququdur — imtiyaz deyil.", sub: "Xidmət əlçatmaz olanda könüllü həkimlərimiz dəstək olur. Bir-birimizə sahib çıxmaq hamımızın məsuliyyətidir.", cta: "Müraciət et" },
      ],
      hp: { eyebrow: "Sağlamlıq turizmi & telemedisina", t1: "Dünya səviyyəli tibb", t2: "Türkiyədə.", btn: "Həkimlə danış" },
      live: "CANLI",
