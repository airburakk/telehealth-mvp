...
export const VIDEOS = {
  ...
  // v6 (2026-08-18): logo intro/kapanis SAG BLOKTA (CX 1420) — hero metinleri
  // sola dayali oldugundan logo arkada kalmaz; kapanis mark'i perdeyle senkron
  // belirir (S6y'deki yuzun ustune ciplak binmez).
  // Ad-versiyonlama onbellek deler (v3 → v5 → v6; ayni URL'de icerik degistirilmez).
  ...
  hero: {
    src: "/assets/video/v-hero6.mp4",
    src720: "/assets/video/v-hero6-720.mp4",
    poster: "/assets/video/p-hero6.jpg",
  },
      ...
      guides: [
        {
          ...
          steps: [
            ...
            { t: "Завършете плащането", d: "Една прозрачна такса, платена с карта. (Демо версия — реално плащане не се взема.)" },
        ...
        },
        {
          ...
          steps: [
            ...
            { t: "Влезте в AURA", d: "Отворете потока Второ мнение и създайте своето досие." },
        ...
        },
        {
          ...
          steps: [
            ...
            { t: "Получете офертата си", d: "Ясен пакет, покриващ лечение, престой и логистика." },
        ...
        },
        {
          ...
          steps: [
            ...
            { t: "Кандидатствайте онлайн", d: "Кратка кандидатура с основното за вашата ситуация." },
