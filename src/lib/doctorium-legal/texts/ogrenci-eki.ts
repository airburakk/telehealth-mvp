...
Doctorium, tıp fakültesi öğrencilerine **içerik erişimiyle sınırlı** bir üyelik sunar. Amacımız,
mesleki bilgiye erişimi öğrencilik döneminde de mümkün kılmaktır.

**Yaş şartı.** Öğrenci üyeliği için **18 yaşını doldurmuş** olmanız gerekir. Kayıt sırasında doğum
tarihiniz beyanınıza dayanılarak alınır; 18 yaşını doldurmamış başvurular kabul edilmez ve başvuru
sahibine 18 yaşını doldurduğunda yeniden başvurabileceği bildirilir.

## 2. Nasıl doğrulanırsınız

Öğrenci üyeliği, **üniversitenize ait e-posta adresinizin** doğrulanmasıyla açılır:

1. Kayıt sırasında üniversite ve bölüm bilgisini seçersiniz.
2. Verdiğiniz e-posta adresinin uzantısı, tanınan üniversite listesiyle eşleştirilir.
3. Adresinize gönderilen bağlantıya tıklamanızla doğrulama tamamlanır.

Üniversiteniz tanınan listede yoksa **bilgi@doctorium.tr** adresine başvurabilirsiniz; üniversite
e-posta uzantısı doğrulandığında listeye eklenir.

Bu doğrulama, **üniversite e-posta adresinize erişebildiğinizi** gösterir; öğrencilik statünüzün
kurum nezdinde teyidi anlamına gelmez.

## 3. Öğrenci üyeliğinin kapsamı
...
**Erişemedikleriniz:**
- **Klinik alanlar** — Doctorium'un doktorlara açık klinik işlevleri öğrenci üyeliğine kapalıdır
- **Sponsorlu içerik, anketler ve puan/ödül programı** — bu yüzeyler öğrenci üyeliğinde
  **kapalıdır**
