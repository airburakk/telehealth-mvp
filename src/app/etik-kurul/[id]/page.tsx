...
export default async function ComplaintDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-4xl px-5 py-8">
      <Link href="/etik-kurul" className="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-[#0EA5B2]">
      ...
      <div className="mt-4 flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-mono text-xl font-bold text-[#101010]">{maskCaseId(c.caseId)}</h1>
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
              <span className="rounded-lg bg-white px-2.5 py-1 text-sm font-semibold text-[#101010] ring-1 ring-slate-200">{c.case.branch}</span>
        ...
        <aside className="space-y-4">
          {booking && esc && (
            <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <div className="mt-2 text-2xl font-bold text-[#101010]">{formatUSD(booking.total)}</div>
