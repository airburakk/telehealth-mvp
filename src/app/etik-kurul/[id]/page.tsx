        ...
        <div className="space-y-5">
          ...
          {resolved && (
            <div className="rounded-3xl border border-emerald-400/25 bg-emerald-500/10 p-6">
              <div className="flex items-center gap-1.5 aura-mono text-[11px] uppercase tracking-[0.2em] text-emerald-300"><Gavel size={15} /> Kurul Kararı</div>
        ...
        <aside className="space-y-4">
          {booking && esc && (
            <div className="rounded-3xl border border-[var(--c-hairline)] bg-[var(--c-panel)] p-5 shadow-sm">
              <div className="flex items-center gap-1.5 aura-mono text-[11px] uppercase tracking-[0.2em] text-[var(--c-ink-2)]"><Lock size={15} /> İlgili Rezervasyon</div>
