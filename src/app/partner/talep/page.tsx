...
const FORM_UI = {
  ...
  docsHelp: "PDF, görüntü veya DICOM (.dcm). Lab/radyoloji/epikriz AI ile değerlendirilir, Türkçeye çevrilir ve FHIR olarak kodlanır. DICOM dosyalarındaki kimlik etiketleri sunucuda otomatik temizlenir. Üzerinde hasta kimliği bulunmayan belgeler yükleyin.",
  addDoc: "Belge ekle",
  dicomConfirm: "Yüklediğim DICOM görüntülerinin üzerinde (piksellerde) hastayı tanımlayan yazı bulunmadığını kontrol ettim. Dosya etiketlerindeki kimlik bilgileri sistem tarafından otomatik temizlenir; görüntünün içine işlenmiş yazılar temizlenmez.",
