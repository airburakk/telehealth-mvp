...
const FORM_UI = {
  ...
  docsHelp: "PDF, görüntü veya DICOM (.dcm). Lab/radyoloji/epikriz AI ile değerlendirilir, Türkçeye çevrilir ve FHIR olarak kodlanır. DICOM dosyalarındaki kimlik etiketleri sunucuda otomatik temizlenir; görüntünün içine işlenmiş yazıları da kontrol edip kapatabilirsiniz. Üzerinde hasta kimliği bulunmayan belgeler yükleyin.",
  addDoc: "Belge ekle",
  redactOpen: "Görüntüdeki yazıları kontrol et",
  redactDone: "alan gizlendi — düzenle",
  dicomConfirm: "Gönderdiğim DICOM görüntülerini açıp üzerlerinde hastayı tanımlayan yazı kalmadığını kontrol ettim. Dosya etiketlerindeki kimlik bilgileri ve bilinen cihaz bilgi şeritleri sistem tarafından temizlenir; görüntünün içine işlenmiş diğer yazıların kapatılması benim sorumluluğumdadır.",
  ...
  errDicomBig: "DICOM çok büyük (max ~8MB).",
  errDicomConfirm: "DICOM eklediyseniz görüntü üzeri kimlik kontrolü onayını işaretleyin.",
  errOnlyPdfImg: "yalnız PDF, görüntü ve DICOM (.dcm) desteklenir.",
