...
import { releaseDoctor } from "@/lib/pro-bono";
import { notifyRoles } from "@/lib/notify";

// POST /api/pro-bono/outcome — doktor görüşme sonucu: CONSULT_DONE (kapat) | TREATMENT_NEEDED (→ etik kurul).
export async function POST(req: Request) {
  ...
  return NextResponse.json({ ok: true, proBonoStatus: newStatus });
}
