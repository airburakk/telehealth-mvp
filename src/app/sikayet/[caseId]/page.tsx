  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-8">
      ...
      <div className="mt-4 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-[var(--c-ink)]">Tahkim & Etik Denetim</h1>
      ...
      <div className="mt-7 grid gap-5 sm:grid-cols-[1fr_260px]">
        ...
        <aside className="space-y-4">
          <div className="rounded-3xl border border-[var(--c-hairline)] bg-[var(--c-panel)] p-5 shadow-sm">
            <div className="text-xs font-semibold uppercase tracking-wide text-[var(--c-ink-2)]">Bağımsız Kurul</div>
