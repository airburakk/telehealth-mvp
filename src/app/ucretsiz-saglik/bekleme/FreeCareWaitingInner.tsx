...
// Suspense'siz (2026-08-28 denetimi): sarmalayıcı page.tsx artık server component + force-dynamic —
// statik prerender hiç denenmediğinden useSearchParams() Suspense'e ihtiyaç duymaz (bkz.
// src/app/giris/page.tsx aynı not).
export function FreeCareWaitingInner() {
