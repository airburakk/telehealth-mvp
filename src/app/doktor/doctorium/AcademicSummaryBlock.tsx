...
// fark etmez). Uyarı bandı KALDIRILAMAZ: bu bir karar destek aracı değildir — bileşenle birlikte
// taşınır, çağıran kapatamaz. Başlık "2 dakikalık" ibaresi portalda kalır; landing `compact`
// modunda ölçülmemiş süre iddiası YAZILMAZ ([[public-claim-honesty]]).
export function AcademicSummaryBlock({ summary, compact = false }: { summary: ClinicalSummary; compact?: boolean }) {
  return (
