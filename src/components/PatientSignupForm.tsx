  ...
  return (
    <div className="w-full max-w-sm">
      <div className="mb-6 flex flex-col items-center text-center">
        ...
        <h1 className="mt-3 flex items-center gap-1.5 font-serif text-xl font-bold tracking-tight text-[var(--c-ink)]"><HeartPulse size={20} className="text-[var(--c-accent)]" /> Hasta Üyeliği</h1>
        <p className="text-sm text-[var(--c-ink-2)]">Birkaç adımda hesabınızı oluşturun</p>
      </div>
