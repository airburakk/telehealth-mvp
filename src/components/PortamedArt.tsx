...
// Palet: teal #0E9E97 · teal-deep #0A7D77 · teal-bright #5FD0C7 · emerald #0A3F39 · ivory #F4F1E8 · gold #C6A664
...
export function HeroArt() {
  return (
    <svg viewBox="0 0 400 500" className="h-full w-full" preserveAspectRatio="xMidYMid slice" aria-hidden>
      ...
      <ellipse cx="200" cy="168" rx="56" ry="92" transform="rotate(-18 200 168)" fill="none" stroke="#0E9E97" strokeWidth="17" strokeLinecap="round" />
      <ellipse cx="200" cy="168" rx="56" ry="92" transform="rotate(-18 200 168)" fill="#F4F1E8" opacity="0.35" />

      {/* Kuşlar */}
      <path d="M96 96 q7 -7 14 0 M110 96 q7 -7 14 0" stroke="#0A3F39" strokeWidth="2.4" fill="none" strokeLinecap="round" opacity="0.55" />
      <path d="M292 122 q6 -6 12 0 M304 122 q6 -6 12 0" stroke="#0A3F39" strokeWidth="2.2" fill="none" strokeLinecap="round" opacity="0.4" />
      ...
      <g transform="translate(284 396)">
        <path d="M0 18 h74 l-10 16 h-54 z" fill="#0A3F39" />
        <rect x="12" y="6" width="44" height="13" rx="3" fill="#F4F1E8" />
        <rect x="20" y="9" width="6" height="6" rx="1.5" fill="#0A7D77" />
        <rect x="31" y="9" width="6" height="6" rx="1.5" fill="#0A7D77" />
        <rect x="42" y="9" width="6" height="6" rx="1.5" fill="#0A7D77" />
...
export function PackArtHair() {
  return (
    <svg viewBox="0 0 400 300" className="h-full w-full" preserveAspectRatio="xMidYMid slice" aria-hidden>
      ...
      {/* Profil silüeti */}
      <path d="M150 268 v-36 c-26 -8 -44 -32 -44 -62 0 -38 30 -68 70 -68 38 0 68 27 70 64 1 14 -3 22 7 34 4 5 3 10 -4 12 -5 1 -6 3 -5 9 0 4 -2 7 -6 8 -3 1 -4 3 -3 7 2 8 -3 13 -12 12 l-14 -1 v21 z" fill="#0A3F39" />
...
export function PackArtSmile() {
  return (
    <svg viewBox="0 0 400 300" className="h-full w-full" preserveAspectRatio="xMidYMid slice" aria-hidden>
      ...
      {/* Diş */}
      <path d="M158 86 c-26 0 -42 20 -40 46 2 24 10 34 12 56 1 13 6 26 16 26 9 0 10 -11 12 -22 2 -12 4 -18 12 -18 8 0 10 6 12 18 2 11 3 22 12 22 10 0 15 -13 16 -26 2 -22 10 -32 12 -56 2 -26 -14 -46 -40 -46 -7 0 -17 4 -12 4 5 0 -5 -4 -12 -4 z" fill="#FDFCF8" stroke="#0A3F39" strokeWidth="7" strokeLinejoin="round" transform="translate(28 0)" />
      {/* Parlama */}
      ...
      {/* Gülüş yayı */}
      <path d="M132 238 q84 36 164 -10" stroke="#0E9E97" strokeWidth="7" fill="none" strokeLinecap="round" />
    </svg>
  );
}
...
export function PackArtIvf() {
  return (
    <svg viewBox="0 0 400 300" className="h-full w-full" preserveAspectRatio="xMidYMid slice" aria-hidden>
      ...
      <circle cx="200" cy="150" r="86" fill="none" stroke="#0A3F39" strokeWidth="7" />
      <circle cx="200" cy="150" r="86" fill="#F4F1E8" opacity="0.5" />
      <g fill="#0E9E97" opacity="0.92">
...
export function TestimonialArt() {
  return (
    <svg viewBox="0 0 240 240" className="h-full w-full" preserveAspectRatio="xMidYMid slice" aria-hidden>
      ...
      <path d="M120 170 l-17 16 17 34 17 -34 z" fill="#0E9E97" />
      {/* Boyun + baş */}
